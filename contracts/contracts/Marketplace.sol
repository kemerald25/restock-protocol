 ...
 * Fulfillments are stubbed out for Part 3b.
 * 
...
contract Marketplace is IMarketplace {
    ...
    constructor(IClaimToken _claimToken, ISKURegistry _skuRegistry) {
    ...
    /// @notice Stubbed out for Part 3b.
    function fulfillReservation(uint256 reservationId) external override {
        // Write to state variable to silence pure/view mutability warning
        _reservedQuantities[0] = _reservedQuantities[0];
        reservationId;
        // TODO: implement in Phase 1, Part 3b
        revert("Marketplace: fulfillReservation not yet implemented");
    }
